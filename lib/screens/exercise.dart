...
class Exercise extends StatefulWidget {
  final int index;
  Exercise({Key key, @required this.index, img, name}) : super(key: key);
...
class _ExerciseState extends State<Exercise> {
  ...
  void runYoutubePlayer() {
    _controller = YoutubePlayerController(
        initialVideoId: exercises[widget.index].url,
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
              ...
              child: Row(
                children: <Widget>[
                  SmoothStarRating(
                    ...
                    rating: exercises[widget.index].difficulty,
                    size: 10.0,
                  ),
                  SizedBox(width: 10.0),
                  Text(
            ...
            SizedBox(height: 10.0),
            Text(
              exercises[widget.index].precautions,
              style: TextStyle(
                fontSize: 13,
